...
namespace IBSTree.Tree
{
    public class Tree<T> where T : IComparable<T>
    {
        ...
        private TreeNode _pointer;

        public TreeNode Root { get; set; }

        public Tree()
        {
            _pointer = new TreeNode();
            Root = _pointer;
        }
        ...
        public TreeNode Add2(int L, int R)
        {
            if (L > R)
            {
                return null;
        ...
        public int CheckSum(TreeNode treeNode)
        {
            if (treeNode != null)
            {
        ...
        public int HeightsOfTree(TreeNode treeNode)
        {
            if (treeNode != null)
            {
        ...
        public int SumOfLenPaths(TreeNode treeNode, int L)
        {
            if (treeNode != null)
            {
